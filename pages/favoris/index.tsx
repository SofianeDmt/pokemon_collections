    ...
    return (
        <main className="flex-col min-h-screen items-center justify-between h-screen text-center bg-gray-200 text-black">
            <div>
                ...
                <p className="my-2 text-xs font-light">Les favoris utilisent le local storage du navigateur car aucune base de données {"n'est"} disponible, veuillez ne pas effacer la clé &quot;PokeFav&quot; de celui-ci.</p>
            </div>
